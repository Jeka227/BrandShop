...
class ControllerProductSpecial extends Controller {
	public function index() {
		...
		/*$results = $this->model_catalog_product->getProductSpecials($filter_data);*//*start FilterVier*/foreach($this->model_extension_module_filter_vier->getProductsByFilterVier($filter_data) as $k=>$v){${$k}=$v;}/*end FilterVier*/
		...
		$data['sorts'][] = array(
			...
			'href'  => $this->url->link('product/special', $url_plus . '&sort=p.sort_order&order=ASC' . $url)
		);

		$data['sorts'][] = array(
			'text'  => $this->language->get('text_name_asc'),
			'value' => 'pd.name-ASC',
			'href'  => $this->url->link('product/special', $url_plus . '&sort=pd.name&order=ASC' . $url)
		);

		$data['sorts'][] = array(
			'text'  => $this->language->get('text_name_desc'),
			'value' => 'pd.name-DESC',
			'href'  => $this->url->link('product/special', $url_plus . '&sort=pd.name&order=DESC' . $url)
		);

		$data['sorts'][] = array(
			'text'  => $this->language->get('text_price_asc'),
			'value' => 'ps.price-ASC',
			'href'  => $this->url->link('product/special', $url_plus . '&sort=ps.price&order=ASC' . $url)
		);

		$data['sorts'][] = array(
			'text'  => $this->language->get('text_price_desc'),
			'value' => 'ps.price-DESC',
			'href'  => $this->url->link('product/special', $url_plus . '&sort=ps.price&order=DESC' . $url)
		);
		...
		if ($this->config->get('config_review_status')) {
			$data['sorts'][] = array(
				...
				'value' => 'rating-DESC',
				'href'  => $this->url->link('product/special', $url_plus . '&sort=rating&order=DESC' . $url)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_rating_asc'),
				'value' => 'rating-ASC',
				'href'  => $this->url->link('product/special', $url_plus . '&sort=rating&order=ASC' . $url)
			);
		}
		...
		$data['sorts'][] = array(
				...
				'value' => 'p.model-ASC',
				'href'  => $this->url->link('product/special', $url_plus . '&sort=p.model&order=ASC' . $url)
		);

		$data['sorts'][] = array(
			'text'  => $this->language->get('text_model_desc'),
			'value' => 'p.model-DESC',
			'href'  => $this->url->link('product/special', $url_plus . '&sort=p.model&order=DESC' . $url)
		);
		...
		foreach($limits as $value) {
			$data['limits'][] = array(
				'text'  => $value,
				'value' => $value,
				'href'  => $this->url->link('product/special', $url_plus . $url . '&limit=' . $value)
			);
		}
		...
		$pagination->url = $this->url->link('product/special', $url_plus . $url . '&page={page}');
